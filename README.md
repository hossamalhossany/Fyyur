...
here i make many changes at app.py 
1- add new table (show) with two foreign keys to (artist, venue) tables 
2- insert data to tables
3- get data from tables
4- make queries at table and get data back to user
5- make join tables to get data from three tables

and i make many changes at templates foler 
